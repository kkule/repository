...
!(async () => {
  ...
  $.temp = [];
  $.updatePkActivityIdRes = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/jd_cityShareCodesm.json')
  if (!$.updatePkActivityIdRes) {
    $.http.get({url: 'https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/jd_cityShareCodesm.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    $.updatePkActivityIdRes = await getAuthorShareCode('https://xr2021.coding.net/p/import-kasd/d/JDbot/git/raw/master/shareCodes/jd_cityShareCodesm.json')
  }
  await requireConfig();
